...
此项目为[proxypool](https://github.com/buqian123/proxypool)的代理池节点可用性检测部分，并提供检测后可用的代理。

此项目推荐在本地（即您家里）部署，或是的中国大陆服务器上运行，以提升代理池节点的实际可用比例。

在使用此项目之前，您应该有一个（或知道一个）可用的[proxypool](https://github.com/buqian123/proxypool)服务器。
...
从[releases](https://github.com/buqian123/proxypoolCheck/releases)中下载
